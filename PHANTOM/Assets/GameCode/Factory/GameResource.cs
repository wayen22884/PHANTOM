...
public static class GameResource
{
    public static void Initialize()
    {
        ...
        Addressables.LoadAssetAsync<GameObject>("Prefabs/PlayerModel.prefab").Completed +=
            (i) => { PlayerModel = i.Result; };
        Addressables.LoadAssetAsync<GameObject>("Prefabs/EnemyModel.prefab").Completed +=
            (i) => { enemy1Model = i.Result; };
        Addressables.LoadAssetAsync<GameObject>("Prefabs/AttackTrigger.prefab").Completed +=
            (i) => { AttackTrigger = i.Result; };
        ...
        Addressables.LoadAssetAsync<PlayerBaseAttr>("DataForTest/PlayerBaseData.asset").Completed +=
            (i) => { PlayerBaseAttr = i.Result; };
        Addressables.LoadAssetAsync<AudioClip>("Music_battlefield_BGMstart_loop").Completed +=
            (i) => { BattleStartBGM = i.Result; };
        Addressables.LoadAssetAsync<AudioClip>("Music_battlefield_BGM_loop").Completed +=
            (i) => { BattleLoopBGM = i.Result; };
        Addressables.LoadAssetAsync<AudioClip>("Music_Title_BGMStart").Completed +=
            (i) => { TitleStartBGM = i.Result; };
        Addressables.LoadAssetAsync<AudioClip>("Music_Title_Loop").Completed += (i) => { TitleLoopBGM = i.Result; };
        Addressables.LoadAssetAsync<AudioClip>("Music_Final_Victory_Stinger").Completed +=
            (i) => { VictoryBGM = i.Result; };
        Addressables.LoadAssetAsync<AudioClip>("Music_Final_Failure_Stinger").Completed +=
            (i) => { FailureBGM = i.Result; };
        ...
        Addressables.LoadAssetAsync<AudioClip>("Music_StoryPrologue").Completed += (i) => { StoryPrologue = i.Result; };
        Addressables.LoadAssetAsync<Combo>("PlayerCombo").Completed += (i) => { Combo = i.Result; };
    }
    ...
    public static GameObject EnemyObj(CharacterID EnemyType)
    {
        ...
        {
            Debug.LogError("not exist Enemy");
            return null;
        }
    }
    ...
    public static GameObject EnemyModel(CharacterID enemyType)
    {
        ...
        {
            Debug.LogError("not exist EnemyModel");
            return null;
        }
    }
    ...
    static AudioMixerGroup FindMusicGroup(string adress)
    {
        ...
        if (Result == null)
        {
            Debug.LogError($"there is no AudioMixerGroup in adress {adress}");
            return null;
        }

        if (Result.Length > 1)
        {
            Debug.LogError($"there is more than one AudioMixerGroup in adress {adress}");
        }
    ...
    public static AudioClip CQCSound(CharacterID ID)
    {
        ...
        {
            Debug.LogError("The sound is not exist");
            return null;
        }
    }
    ...
    public static SaveData SaveData(CharacterID ID)
    {
        ...
        {
            Debug.LogError("The saveData is not exist");
            return null;
        }
    }
